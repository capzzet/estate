    ...
    data: {
        ...
        properties: [
            ...
            },
            {
                ...
                price: '$320,000',
                description: 'Просторный дом с видом на море, который включает 4 спальни и 3 ванные комнаты.',
                image: 'example-house3.jpg',
                progress: 25,
                status: 'В процессе',
                time: '3 год до завершения',
                icons: [
                    { src: 'bed.svg', alt: 'Спальни', label: '4 спальни' },
                    { src: 'bath.svg', alt: 'Ванные', label: '3 ванные' },
                    { src: 'square.svg', alt: 'Гараж', label: '350м²' }
                ]
            },
            {
                title: 'Atlanta House',
